                    ...
                    renderItem={(recipe) => (
                        <List.Item>
                            <Card
                                ...
                                hoverable
                                cover={<img alt={recipe.name} src={recipe.recipeImg} style={{ borderRadius: '10px', maxHeight: '200px', objectFit: 'cover' }} />}
                                actions={[
                                    <Button
                                        type="primary"
                                        icon={
                                        ...
                                        style={{
                                            backgroundColor: isRecipeSaved(recipe._id) ? '#52c41a' : '#1890ff',
                                            borderColor: isRecipeSaved(recipe._id) ? '#52c41a' : '#1890ff',
                                        }}
                                    >
                            ...
                            >
                                <Meta
                                    title={<span style={{ fontWeight: 'bold' }}>{recipe.name}</span>}
